...
class AgendaAgent(BaseAgent):
    ...
    def run_review(self, force: bool = False) -> None:
        ...
        query = (
            ...
            "   KEEP if the item is: overdue, due today, #action-required, or has no date/tag at all\n"
            "     (= semantically incomplete — user placed it manually, keep until they tag/move/close it).\n"
            "   MOVE to This Week if the item has a clear future date or dependency not yet due.\n"
