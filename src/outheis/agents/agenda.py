...
class AgendaAgent(BaseAgent):
    ...
    def run_review(self, force: bool = False) -> None:
        ...
        query = (
            ...
            "   Then fill remaining capacity from Shadow.md (max 5 total):\n"
            "   Priority 1: overdue (date < today) and due today.\n"
            "   Priority 2 if slots remain: near-deadline (within ~10 days), blocks something else,\n"
            "   or has been open for multiple days. Use judgment — pick what is most actionable today.\n"
