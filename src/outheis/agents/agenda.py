...
class AgendaAgent(BaseAgent):
    ...
    def run_review(self, force: bool = False) -> None:
        ...
        query = (
            ...
            "     Optional (add in chronological order, no item cap, up to 30 days out):\n"
            "       - #date within 30 days → include in chronological order.\n"
            "       - #action-required with a future date → include in chronological order.\n"
