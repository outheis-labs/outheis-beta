...
- Agenda.md contains only today's information. It is a single-day file, not a multi-day document.
...
- Lines starting with `>` in Agenda.md are action instructions, not notes.
