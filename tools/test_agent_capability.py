...
Vault root: /Users/markus/Documents/Obsidian
...
## Termine
- 10:00 Call mit Stefan (Infra-Review)
- 14:00 outheis Architektur-Review

## Tasks
- [ ] MCP-Integration fuer hiro
- [ ] Test lokale Modelle
- [x] Relay interim messages

## Notizen
RAM fuer M5: mindestens 32 GB geplant.
"""
...
- relay: fertig
- data, agenda: fertig
- action (hiro): in Arbeit — MCP-Integration ausstehend
- pattern: fertig

## Naechste Schritte
- MCP-Client in hiro implementieren
- Dispatcher verwaltet Server-Lifecycle
"""
...
SCENARIOS = [
    ...
    Scenario(
        ...
        system=relay_system(),
        tools=RELAY_TOOLS,
        user_message="Welche Projekte sind aktiv?",
    ...
    Scenario(
        ...
        system=relay_system(),
        tools=RELAY_TOOLS,
        user_message="Was machst du eigentlich?",
        expected_tool=None,
        verify_keywords=[],
        reject_keywords=[],
    ...
    Scenario(
        ...
        system=data_system(),
        tools=DATA_TOOLS,
        user_message="Welche Notizen sind mit 'active' getaggt?",
    ...
    Scenario(
        ...
        system=data_system(),
        tools=DATA_TOOLS,
        user_message="Zeige mir den Inhalt von Projects/outheis-dev.md",
    ...
    Scenario(
        ...
        system=data_system(),
        tools=DATA_TOOLS,
        user_message="Zeige mir Projects/outheis-dev.md",
        expected_tool="read_vault_file",
    ...
    Scenario(
        ...
        system=data_system(),
        tools=DATA_TOOLS,
        user_message="Zeige mir alle Dateien mit Tag 'budget'.",
        expected_tool="search_vault",
        verify_keywords=["keine", "not found", "no files", "nicht", "archived"],
    ...
    Scenario(
        ...
        tools=AGENDA_TOOLS,
        user_message="Was steht heute in meiner Agenda?",
    ...
    Scenario(
        ...
        system=agenda_system(),
        tools=AGENDA_TOOLS,
        user_message="Fuge morgen um 09:00 einen Termin 'Teammeeting' ein.",
