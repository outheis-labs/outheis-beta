...
def run_single_call(client, model: str, src_root: str, question: str, timeout: int = 45) -> tuple[bool, str, float]:
    """
...
def run_full_loop(client, model: str, src_root: str, question: str, timeout: int = 45) -> tuple[list[str], str, float]:
    """
...
def main():
    ...
    if args.full:
        ...
        for model in models:
            try:
                calls, answer, elapsed = run_full_loop(client, model, src_root, question, args.timeout)
        ...
        for model in models:
            try:
                called, detail, elapsed = run_single_call(client, model, src_root, question, args.timeout)
