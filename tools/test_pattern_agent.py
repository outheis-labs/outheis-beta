...
Recent conversation:
User: I'm Markus. I work on outheis, a privacy-focused AI assistant.
...
{
  "user": [
    [0, {"content": "User is named Markus", "created_at": "2026-03-01", "confidence": 0.9}],
    [1, {"content": "The user's name is Markus Schatzl", "created_at": "2026-03-05", "confidence": 0.95}],
    [2, {"content": "User goes by Markus", "created_at": "2026-03-10", "confidence": 0.8}],
...
[feedback] User changed "15. März" to "2026-03-15" and asked to always use ISO dates (2026-02-18)
...
[user] User is named Markus (2026-03-01)
...
[user] User is named Markus (confidence: 0.9)
